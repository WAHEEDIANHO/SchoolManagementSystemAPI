...
public class LessonQuestionRepository: GenericRepository<LessonQuestion, AppDbContext>, ILessonQuestionRepository
{
    public LessonQuestionRepository(AppDbContext context): base(context){}
}